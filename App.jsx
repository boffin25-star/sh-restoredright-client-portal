...
import blueprintLightUrl from "./blueprint-house.svg";
import blueprintInvertedUrl from "./blueprint-house-login-inverted.svg";
...
function Logo({ className = "" }) {
  return <img className={className} src={logoUrl} alt="S&H Services Spokane LLC" />;
}
  ...
  return <div className="portal-shell">
    ...
    <style>{`
      *{box-sizing:border-box} body{margin:0;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:${BRAND.text};background:${BRAND.offWhite}}
      ...
      .workspace{flex:1;background:linear-gradient(rgba(6,43,96,.73),rgba(6,43,96,.83)),url("${blueprintInvertedUrl}") center/cover fixed no-repeat;padding:26px}.workspace-inner{max-width:1450px;margin:0 auto}.page-kicker{color:#fff;font-size:21px;font-weight:850;margin:0 0 14px;text-shadow:0 2px 4px rgba(0,0,0,.15)}
