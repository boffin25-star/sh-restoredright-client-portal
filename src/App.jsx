...
function Logo({ className = "" }) {
  return <img className={className} src="/sh-box-logo.png" alt="S&H Services Spokane LLC" />;
}
...
function ClientApp({ session }) {
  ...
  return <div className="portal-shell">
    <aside className="desktop-sidebar">
      ...
      <div className="sidebar-bottom"><img className="restoredright-sidebar-badge" src="/restoredright-badge.png" alt="The RestoredRight System — Restoration Done Right!" /></div>
    </aside>
    ...
    <style>{`
      *{box-sizing:border-box} body{margin:0;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:${BRAND.text};background:${BRAND.offWhite}}
      ...
      .workspace{flex:1;background:linear-gradient(rgba(6,43,96,.73),rgba(6,43,96,.83)),url("/blueprint-house-login-inverted.jpg") center/cover fixed no-repeat;padding:26px}.workspace-inner{max-width:1450px;margin:0 auto}.page-kicker{color:#fff;font-size:21px;font-weight:850;margin:0 0 14px;text-shadow:0 2px 4px rgba(0,0,0,.15)}
